...
public class GiftCertificatePaymentView extends PaymentView {
    ...
    private void initComponents() {
        ...
        tfFaceValue.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        tfAmountTendered.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
...
//		double tenderedAmount = Math.ceil(totalPrice);
	...
	public void updateView() {
		tfFaceValue.setText("50.00");
                NumberValueNoDecimal numVal = new NumberValueNoDecimal(true);
                numVal.setValue(getDueAmount());
		tfAmountTendered.setText(numVal.getStringValue());
	}
}
