...
public class CardPaymentView extends PaymentView {
    ...
    private void initComponents() {
        ...
        btnSettle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/settle_ticket_32.png"))); // NOI18N
        ...
        posButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/00_32.png"))); // NOI18N
        posButton10.setActionCommand("00");
        ...
        btnMasterCard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/master_card.PNG"))); // NOI18N
        ...
        btnVisa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/visa_card.PNG"))); // NOI18N
        ...
        btnEmEx.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/am_ex_card.PNG"))); // NOI18N
        ...
        btnDiscover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/discover_card.PNG"))); // NOI18N
        ...
        tfAuthorizationCode.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        tfCardAmount.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
	...
	private Action calAction = new AbstractAction() {
		public void actionPerformed(ActionEvent e) {
			JTextField tf = getFocusedTextField();
                        NumberValueNoDecimal numVal = new NumberValueNoDecimal(true);
                        if(tf == tfAuthorizationCode)
                        {
                            numVal.setFloatingPt(false);
                        }
                        numVal.setValue(tf.getText());
			...
			if (s.equals(com.floreantpos.POSConstants.CLEAR)) {
				tf.setText("0");
                            ...
                            addNumber(numVal, "0");
                            addNumber(numVal, "0");
                            tf.setText(numVal.getStringValue());
			}
			else {				
                                addNumber(numVal,s);
                                tf.setText(numVal.getStringValue());
        ...
        private void addNumber(NumberValueNoDecimal numVal, String num)
        {
            try {
             Double value = Double.parseDouble(num);
             numVal.add(value.intValue());
            } catch (NumberFormatException x) 
            {
		Toolkit.getDefaultToolkit().beep();
	    }
