...
public class PosPrinter {
	...
	public PosPrinter(String sDevicePrinterName, String sDeviceDrawerName) {
		...
		if(!(sDeviceDrawerName == null || sDeviceDrawerName.trim().equalsIgnoreCase("")))
                {
                    try {
	...
	public void reset() {
        ...
        private byte[] getRestaurantImage(String imageName)
        {
            String fileName = imageName;
            if(fileName == null)
            {
                fileName = "/images/jposimg.bmp";
            }
             InputStream is = PosPrinter.class.getResourceAsStream(fileName);
        ...
        {
            printImage(getRestaurantImage(name));
        }
        
        public void printImage()
        {
            printImage(getRestaurantImage(null));
        }
...
//		                    out.close();
//		
		                    m_printer.printMemoryBitmap(POSPrinterConst.PTR_S_RECEIPT, bytes, POSPrinterConst.PTR_BMT_BMP,POSPrinterConst.PTR_BM_ASIS, POSPrinterConst.PTR_BM_CENTER);
		                }
		            } catch (JposException e) {
                                e.printStackTrace();
		            }
